...
const ProductContextProvider = (props) => {
  ...
  const initialState = [
    {id: 1, title: 'Redmi Note 4', description: 'An official MIUI redmi note 4 device.', category: 'Electronics', price: 249.99,top_item: false, stock: 25},
    ...
    {id: 5, title: 'VCorp Corp Home Cleaner', description: 'VCorp Corp official Home cleaner.', category: 'Lifestyle', price: 14.99,top_item: true, stock: 988},
    ...
    {id: 7, title: 'VCorp Corp Sofa Set', description: 'A sofa set by the made in aduland initiative by VCorp Corp', category: 'Home', price: 349.99,top_item: false, stock: 4},
    {id: 8, title: 'VCorp Curtain', description: 'Official VCorp curtain set.', category: 'Home', price: 39.99,top_item: true, stock: 24},
    {id: 9, title: 'VCorp Shirts', description: '', category: 'Fashion', price: 19.99,top_item: true, stock: 100},
    {id: 10, title: 'VCorp Home Brush', description: 'Clean your Homes with brown VCorp Home brushes.', category: 'Lifestyle', price: 5.99, top_item: false, stock: 46}
  ]
